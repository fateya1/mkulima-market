        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="space-y-4">
            {userTypes.map((type) => (
              <div
                key={type.id}
                className={`relative border-2 rounded-lg p-4 cursor-pointer transition-all ${selectedType === type.id
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-auto">
                    <div className={`h-6 w-6 border-2 rounded-full flex items-center justify-center ${selectedType === type.id
          ...
          <div className="mt-8">
            <button
              ...
              className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 ${!selectedType || isLoading ? 'opacity-50 cursor-not-allowed' : ''
                }`}
            >
